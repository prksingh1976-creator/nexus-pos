...
export const Orders: React.FC = () => {
  const { transactions, updateOrderStatus, user } = useShop();
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
                      ...
                      <div className="flex flex-col md:flex-row justify-between md:items-center border-b border-slate-100 dark:border-slate-700 pb-4 mb-4 gap-4">
                          <div>
                              <div className="flex items-center gap-3 mb-1">
                                  <span className="font-bold text-lg text-slate-800 dark:text-white">#{order.id.slice(0, 8)}</span>
                      ...
                      {order.status === 'queued' && (
                          <div className="flex gap-3 pt-2">
                              ...
                              <button 
                                  ...
                                  className="flex-1 bg-white dark:bg-slate-700 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 py-2 rounded-lg font-medium transition-colors"
                              >
                                  Cancel Order
                              </button>
                          </div>
      ...
      {/* Payment Modal for Queued Orders */}
